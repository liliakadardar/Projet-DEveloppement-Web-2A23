                    ...
                    <div class="col-lg-7 col-md-12">
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li><a href="#">Forum</a>
								...
								<li><a href='triforum.php'>Les Derniers Comments</a></li>
									
							<li class='active'><a href='rechercheforum.php'>Recherche Forum</a></li>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-title text-center">
                        <h1>Chercher<span><br><br>Participants/Commentaire</span></h1>
                    </div>
                </div>
            </div>
        </div>
