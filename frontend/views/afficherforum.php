...
<div class="button">
	...
	<td><a href="modifierforum.php?id_post=<?PHP echo $row['id_post']; ?>">
	Modifier</a></td>
	</tr>
	<td/>
  </tbody>
                ...
                <div class="col-lg-12">
                    <div class="blog-single-contetn">
                        ...
                        <div class="blog-single-text">
                            <ul>
                                <li><a href="#"><i class="fas fa-calendar-alt"></i> 29 Nov 2020</a></li>
                                <li><a href="#"><i class="fas fa-user"></i> Admin</a></li>
                            </ul>
                            <h3>Un Contenu Exclusive Chaque Mois Pour Nos Fidéles Clients</h3>
                            <p>Vous Pouvez Contacter Votre Coach Ou Nutritionniste Directement.</p>
                        </div>
