				...
				<!--<div class="col-md-4">
					<div class="fh5co-blog ">
						<div class="title text-center">
							<span class="category"><?//PHP echo $row['nomp']; ?></span>
						</div>
						<a href="#"><date class="commentaire" src="<?PHP echo $rep.$commentaire; ?>" alt=""></a>
						<div class="blog-text text-center">
							<p>Lieu: <?//PHP echo $row['lieu_event']; ?></p>
							<p>Date de fin de l'événements: <?//PHP echo $row['ask']; ?></p>
