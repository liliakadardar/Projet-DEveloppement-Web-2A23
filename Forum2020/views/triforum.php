            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-title text-center">
                        <h1>Les <span><br><br>Derniers Participants</span></h1>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row ">
                <div class="col-lg-8">
                    <div class="section-title text-left">
                        <h2>Voir Les  <span>Derniers Participants</span></h2>
                    </div>
                </div>
            </div>
<div class="row">
...
<div class="content-panel">
   <a  class="btn btn-secondary btn-width-lg">Les Derniers Participants</a>
<hr>
<table class="table">
