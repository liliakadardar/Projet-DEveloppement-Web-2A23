...
<head>
    ...
    <link rel="stylesheet" href="assets3/css/about.css">
    <link rel="stylesheet" href="assets3/css/nutritioniste.css">
   <link rel="stylesheet" href="assets3/css/liste_nutritionniste.css">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-title text-center">
                        ...
                        <h1 class="nut">Nutrition<br>&<br>Alimentations</h1>
 ...
 <!-- =====>> description <<===== 
   ...
   <div class="splitview skewed">
        <div class="panel bottom">
            <div class="content">
                <div class="description">
                    ...
                    <p>Chaque clients aura le privilége de pouvoir consulter nos différents propositions de nutritionnistes.<br>Consulter un médecin nutritionniste peut être motivé par la présence de troubles alimentaires. On pense notamment à la boulimie ou l’anorexie. En bon professionnel polyvalent, il se charge alors de mettre en lumière les causes des troubles et de leur fournir une réponse adaptée. L’objectif étant ici de fournir un accompagnement thérapeutique personnalisé en lien avec les autres médecins spécialistes qui suivent le patient.</p>
                </div>

                <img src="assets3\img\nutritioniste.jpg" alt="Original">
            </div>
        </div>
        ...
        <div class="panel top">
            <div class="content">
                <div class="description">
                    <h1>Ce que vous trouverez !</h1>
                    <p>Soyez a l'écoute de nos experts</p>
                </div>

                <img src="assets3\img\nutritioniste.jpg" alt="Duotone">
            </div>
        </div>
    ...
    <!-- =====>> end description <<===== 
    =========================== -->
    <!-- =====>> liste nutritionniste <<===== 
    =========================== -->
<section class="container">
    <div class="page-header">
        <HR size=8 >
        <h1>Listes des Nutritionnistes <br>
          </h1>
          <HR size=8>
    </div>
    <div class="row active-with-click">
        <div class="col-md-4 col-sm-6 col-xs-12">
            <article class="material-card Red">
                <h2>
                    <span>Ines Kouki</span>
                    
                </h2>
                <div class="mc-content">
                    <div class="img-container">
                        <img class="img-responsive" src="assets3\img\ines.jpg">
                    </div>
                    <div class="mc-description">
                        Diplômée en Médecine de l'obésité (université Claude Bernard Lyon).
Membre de l'Association Française d'Etude et de Recherche sur l'Obésité (AFERO).
Diu Européen en Nutrition Clinique et métabolisme (Université Paris Descartes).
                    </div>
                </div>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
            <article class="material-card Pink">
                <h2>
                    <span>Manel Arfaoui</span>
                   
                </h2>
                <div class="mc-content">
                    <div class="img-container">
                        <img class="img-responsive" src="assets3\img\manel.jpg">
                    </div>
                    <div class="mc-description">
                        Médecin Nutrithérapeute
Diplômée en Nutrithérapie de Besançon
Diplômée en Micronutrition de Dijon
Membre de l'I.E.D.M. (Institut Européen de Diététique et de Micronutrition)
                    </div>
                </div>
                <a class="mc-btn-action">
                    <i class="fa fa-bars"></i>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
            <article class="material-card Purple">
                <h2>
                    <span>Faouzi Ben Salem</span>
                    
                </h2>
                <div class="mc-content">
                    <div class="img-container">
                        <img class="img-responsive" src="assets3\img\faouzi.jpg">
                    </div>
                    <div class="mc-description">
                       Docteur en Médecine,
Diplome de Spécialiste en Diabétologie Nutrition et maladies nutritionnelles (obésité dyslipémie maigreur dénutrition...)
Diplômée de la Faculté de Médecine de Tunis
                    </div>
                </div>
                <a class="mc-btn-action">
                    <i class="fa fa-bars"></i>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
            <article class="material-card Deep-Purple">
                <h2>
                    <span>Emna Khadhraoui</span>
                  
                </h2>
                <div class="mc-content">
                    <div class="img-container">
                        <img class="img-responsive" src="assets3\img\emna.jpg">
                    </div>
                    <div class="mc-description">
                      Médecine Interne
Diabétologie – Nutrition et Obésité
Ancien Professeur à la Faculté de Médecine de Tunis
Ancien Chef de Service à l’institut National de Nutrition
                    </div>
                </div>
                <a class="mc-btn-action">
                    <i class="fa fa-bars"></i>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
            <article class="material-card Indigo">
                <h2>
                    <span>Zoubeir Chater </span>
                    
                </h2>
                <div class="mc-content">
                    <div class="img-container">
                        <img class="img-responsive" src="assets3\img\zoubeir.jpg">
                    </div>
                    <div class="mc-description">
                        DIU Diététique medicale (Fac medecine Montpellier ).
DIU Médecine Esthétique(Fac medecine Paris ile de France ouest).
DIU Mesotherapie (Fac medecine Clermont Ferrand ).
DIU Medecine de l'obésité (Fac medecine lyon 1).
Formation sur l'approche bio-psycho-sensorielle groupe GROS à Paris.
                    </div>
                </div>
                <a class="mc-btn-action">
                    <i class="fa fa-bars"></i>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
            <article class="material-card Blue">
                <h2>
                    <span>Safa Ben Hassen</span>
                   
                </h2>
                <div class="mc-content">
                    <div class="img-container">
                        <img class="img-responsive" src="assets3\img\safa.jpg">
                   </div>
                    <div class="mc-description">
                    doctorat en médecine
diplôme universitaire de nutrition de l'obésité(france)
diplome universitaire de diabétologie(france)
                    </div>
                </div>
                <a class="mc-btn-action">
                    <i class="fa fa-bars"></i>
    ...
    <!-- =====>> end liste nutritionniste <<===== 
    =========================== -->

<input class="favorite styled"
       type="button"
       value="choisir nutritioniste">
    ...
    <script src="assets3/js/liste_nutri.js"></script>
