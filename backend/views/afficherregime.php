<?PHP
	...
	$regimeC=new regimeC();
	$listeregime=$regimeC->afficherregime();
...
<button><a href="recette.php">Back</a></button>
		<button><a href="formregime.php">Ajouter un regime</a></button>
		<hr>
		<table border=1 align = 'center'>
			<tr>
				<th>Id_regime</th>
				<th>Nom_regime</th>
				<th>description_regime</th>
				<th>supprimer</th>
				<th>modifier</th>
			</tr>

			<?PHP
				foreach($listeregime as $regime){
			?>
				<tr>
					<td><?PHP echo $regime['id_regime']; ?></td>
					<td><?PHP echo $regime['nom_regime']; ?></td>
					<td><?PHP echo $regime['description_regime']; ?></td>
					<<td>
						<form method="POST" action="supprimerregime.php">
						<input type="submit" name="supprimer" value="supprimer">
						<input type="hidden" name="id_regime" value=<?PHP echo $regime['id_regime']; ?> >
						</form>
					</td>
					<td>
					<a href="modifierregime.php?id=<?PHP echo $regime['id_regime']; ?>"> Modifier </a>
					</td>
				</tr>
			<?PHP
				}
