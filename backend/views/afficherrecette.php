...
<head>
    ...
    <body>
		...
		<button><a href="formrecette.php">Ajouter une recette</a></button>
		<hr>
		<table border=1 align = 'center'>
			...
			?>
				<tr>
					...
					<td><?PHP echo $recette['nb_aliments']; ?></td>
					<td><?PHP echo $recette['Aliment']; ?></td>
					...
					<td>
						<a href="modifierrecette.php?id=<?PHP echo $recette['id_recette']; ?>"> Modifier </a>
					</td>
				</tr>
			<?PHP
				}
