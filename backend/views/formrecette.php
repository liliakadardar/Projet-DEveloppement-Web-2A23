...
<form action="" method="POST">
    ...
    <input type="text" name="nom_recette" placeholder="Entrer le nom de la recette" required/><br><br>
      <label>nombres D'aliments</label>
      <input type="number" name="nb_aliments"  max="10" min="1" placeholder="Preciser le nombre d'aliments " required/><br><br>
      <label>citer les Aliments</label>
      <input type="text" name="Aliment"  placeholder="Nommer les aliments utilisés" required/><br><br>
   
  
    <label>etapes de realisation</label>
    <input type="text" name="description" placeholder="Enumerer les etapes de la recette"required/><br><br>
