<!DOCTYPE html>
<html lang="en">
<?php include "../controller/recetteC.php";
...
<br><br>
 <div align="center"><a href="calculimc.php" ><input 
                           type="button"
                           value="calculez votre IMC"  > </a></div>
                           <br><br>
 <div align="center"><a href="formrecette1.php" ><input 
                           type="button"
                           value="ajouter recette" > </a></div>
<div align="center"><a href="formregime1.php" ><input 
                           type="button"
                           value="ajouter regime" > </a></div>
