...
$reponse = $bdd->query('SELECT * FROM regime');
...
?>
   ...
   <article>
    <div class="inner">
      ...
      <h2>    <strong>nom regime</strong> : <?php echo $donnees['nom_regime']; ?><br /></h2>
      <p> <strong>Description regime</strong>: <?php echo $donnees['description_regime']; ?><br/></p>
    </div>
  </article>
</section>
<?php
