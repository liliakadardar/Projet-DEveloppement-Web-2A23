...
<body>
 ...
 <!-- ===========================
  ...
  <button><a href="recette.php">Back</a></button>
        <button><a href="formrecette1.php">Ajouter une recette</a></button>
        <hr>
        <table border=1 align = 'center'>
            ...
            ?>
                <tr>
                    ...
                    <<td>
                        <form method="POST" action="supprimerrecette1.php">
                        <input type="submit" name="supprimer" value="supprimer">
                        <input type="hidden" name="id_recette" value=<?PHP echo $recette['id_recette']; ?> >
                        </form>
                    </td>
                    <td>
                        <a href="modifierrecette1.php?id=<?PHP echo $recette['id_recette']; ?>"> Modifier </a>
                    </td>
                </tr>
            <?PHP
                }
