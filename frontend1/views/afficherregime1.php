...
<button><a href="recette.php">Back</a></button>
        <button><a href="formregime1.php">Ajouter un regime</a></button>
        <hr>
        <table border=1 align = 'center'>
            ...
            ?>
                <tr>
                    ...
                    <<td>
                        <form method="POST" action="supprimerregime1.php">
                        <input type="submit" name="supprimer" value="supprimer">
                        <input type="hidden" name="id_regime" value=<?PHP echo $regime['id_regime']; ?> >
                        </form>
                    </td>
                    <td>
                    <a href="modifierregime1.php?id=<?PHP echo $regime['id_regime']; ?>"> Modifier </a>
                    </td>
                </tr>
            <?PHP
                }
