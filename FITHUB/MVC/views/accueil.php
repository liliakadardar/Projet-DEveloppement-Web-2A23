                    ...
                    <div class="row ">
                        <div class="col-lg-8 offset-lg-2 text-center dis-tab ">
                            <div class="slider2-all-text ">
                                ...
                                <a href="membre.php" class="btn btn-1">DEVENIR MEMBRE <i class="fas fa-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row ">
                        <div class="col-lg-8 offset-lg-2 text-center dis-tab">
                            <div class="slider2-all-text ">
                                ...
                                <p></p>
                                <a href="#" class="btn btn-1">DEVNIR MEMBRE <i class="fas fa-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-8 ">
                    <div class="about-left media">
                        <div class="about-left-text">
                            <h2>NOUS SOMMES LA POUR VOUS SOUTENIR</h2>
                        </div>
                ...
                <div class="col-lg-4">
                    <div class="about-right-text">
                        ...
                        <h2>FIT<span style="-webkit-text-stroke: 1px black;">HUB</span> </h2>
                       
                    </div>
                        <p>FitHub est le premier service en Tunisie de coaching sportif en ligne. Avec nos meilleurs coachs de la Tunisie, vous aurez un programme sur mesure accesible ou vous soyez que ce soit au bureau, à la maison, dans un parc, etc..</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="section-title text-center">
                        <h2>POURQUOI CHOISIR FIT<span style="-webkit-text-stroke: 1px black;">HUB</span> </h2>
